...
exports.usersAC = exports.users_reducer = void 0;
...
var users_reducer = function users_reducer() {
  ...
  if (action.type === "SHOW_USERS") {
    axios.get("https://social-network.samuraijs.com/api/1.0/users").then(function (response) {
      ...
      stateCopy = response.data.item.map(function (el) {
        return el;
      });
      return stateCopy;
    });
...
exports.users_reducer = users_reducer;

var usersAC = function usersAC(_type, _text) {
  return {
    type: _type,
    text: _text
  };
